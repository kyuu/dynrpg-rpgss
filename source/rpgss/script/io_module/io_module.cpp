                ...
                luabridge::getGlobalNamespace(L)
                    .beginNamespace("io")
                        ...
                        .beginClass<FileWrapper>("File")
                            ...
                            .addProperty("error",               &FileWrapper::get_error)
                            .addProperty("good",                &FileWrapper::get_good)
                            .addCFunction("__len",              &FileWrapper::__len)
                            .addCFunction("close",              &FileWrapper::close)
                            .addCFunction("clearError",         &FileWrapper::clearError)
                        ...
                        .beginClass<ReaderWrapper>("Reader")
                            .addProperty("stream",              &ReaderWrapper::get_inputStream)
                            .addCFunction("skip",               &ReaderWrapper::skip)
                        ...
                        .beginClass<WriterWrapper>("Writer")
                            .addProperty("stream",              &WriterWrapper::get_outputStream)
